...
export function calcolaContributi({ redditoNetto, riduzioneContributi, dataApertura, annoReddito }) {
    ...
    const aliquoteContributi = {
        2023: {
            contributiFissiAnnui: 4300, // Esempio: 4300€ per il 2023
            aliquotaVariabile: 23.50 // 23.50% per il 2023
        },
        2024: {
            contributiFissiAnnui: 4515, // 4515€ per il 2024
            aliquotaVariabile: 24.48 // 24.48% per il 2024
        },
        2025: {
            contributiFissiAnnui: 4700, // Esempio: 4700€ per il 2025
            aliquotaVariabile: 24.50 // 24.50% per il 2025
        },
